(function () {
  ...
  function trackExposure() {
    if (exposureSent || !document.querySelector("[data-hero-title]")) return;
    if (!window.portfolioAnalytics) return;
    var variant = document.documentElement.getAttribute("data-hero-variant") || getVariant();
